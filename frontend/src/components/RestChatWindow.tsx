...
export default function RestChatWindow({ rideId, sender, messages: messagesProp, onSend, style }) {
  ...
  function bubbleStyle(m) {
    ...
    if (m?.sender?.role === "customer")
      return { background: "#e8f5e9", color: "#388e3c", fontWeight: "bold", borderRadius: 16, padding: "16px 9px", display: "inline-block" };
    return { background: "#eee", color: "#444", borderRadius: 16, padding: "16px 9px", display: "inline-block" };
  }
